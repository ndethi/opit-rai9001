...
* Sourcing existing collections of Kikuyu proverbs, such as "1000 Kikuyu Proverbs" \[15, 16\], which often include literal translations and contextual notes.  
...
1. **Determining the Scope:** Clearly defining the boundaries of the proverb ontology, including the types of proverbs, cultural concepts, and relationships to be captured. This will involve aggregating knowledge about proverb definitions, meanings, properties, attributes, and establishing relationships between classes and terms.\[8\]  
...
3. **Enumerating Terms:** Identifying and listing key terms relevant to Kikuyu proverbs and their cultural context, compiling them from documents and analyzing their meanings to mitigate redundancy.\[8\]  
