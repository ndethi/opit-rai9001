...
% ACM Conference Info (Update with actual CHI2026 details)
\acmConference[CHI 2026]{CHI Conference on Human Factors in Computing Systems}{April 2026}{Barcelona, Spain}
\acmYear{2026}
\copyrightyear{2026}

% Remove ACM copyright block for workshop paper
\setcopyright{none}
\settopmatter{printacmref=false}
\renewcommand\footnotetextcopyrightpermission[1]{}

% Title and Author
\title{Ontology-Grounded RAG for Culturally Faithful Kikuyu Proverb Translation: A Case Study in AI for Low-Resource Languages}
...
% Keywords
\keywords{Cultural AI, Low-Resource Languages, Kikuyu, Proverb Translation, Ontology-Grounded RAG, Indigenous Knowledge Systems, Culturally Faithful NLP}
...
\textbf{Ontology Structure:} Neo4j knowledge graph with nodes (Proverbs, Concepts, Themes, Contexts) and relationships (HAS\_THEME, RELATES\_TO, USED\_IN, TEACHES\_ABOUT). See Figure~\ref{fig:ontology-structure}.
...
\begin{tabular}{lccc}
\toprule
\textbf{System} & \textbf{Cultural Auth.} & \textbf{Trans. Fidelity} & \textbf{Overall} \\
\midrule
Raw GPT-4 & 0.568 $\pm$ 0.080 & 0.308 $\pm$ 0.154 & 0.335 $\pm$ 0.083 \\
Trad RAG & 0.584 $\pm$ 0.088 & 0.334 $\pm$ 0.167 & 0.351 $\pm$ 0.091 \\
\textbf{OG-RAG} & \textbf{0.627 $\pm$ 0.089} & \textbf{0.369 $\pm$ 0.151} & \textbf{0.380 $\pm$ 0.085} \\
\bottomrule
\end{tabular}
\end{table}
...
% You will need a references.bib file with appropriate citations.
% Key references to include:
% - bird2020decolonising: Bird, S. (2020). Decolonising Speech and Language Technology
% - finnegan2012oral: Finnegan, R. (2012). Oral Literature in Africa
% - nekoto2020participatory: Nekoto et al. (2020). Participatory Research for Low-resourced MT
% - orife2020masakhane: Orife et al. (2020). Masakhane: Machine Translation for Africa
% - lewis2020retrieval: Lewis et al. (2020). Retrieval-Augmented Generation
% - li2024ontology: Li et al. (2024). OG-RAG: Ontology-Grounded RAG
% - hershcovich2022challenges: Hershcovich et al. (2022). Challenges in Multilingual NLP
% - ireri2019proverbs: Ireri, M. W. (2019). Kikuyu Proverbs on Money and Wealth
