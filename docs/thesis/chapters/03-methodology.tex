...
\textit{Note: This section incorporates clarifications discussed during the January 14, 2026 thesis defense regarding the evaluation framework and its limitations.}

The evaluation phase employed a dual-automated framework combining computational metrics with AI-assisted assessment to systematically evaluate system performance. As discussed during the defense, all quantitative results reported in Chapter~\ref{chap:evaluation} derive from these automated evaluation methods, supplemented by informal researcher review for qualitative insights.
