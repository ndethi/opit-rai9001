...
Consider the Kikuyu proverb \emph{``Mũtumia mũgima ndagagwo nĩ thĩĩna''} (``A mature woman is never exempt from trouble''). This statement encodes complex cultural attitudes about gender roles, resilience, and life's inevitable challenges—knowledge that resists direct translation \cite{finnegan2012oral}. Proverbs function as compact repositories of worldview, values, and historical experience, shaping community identities through memorable, transmissible forms. In African oral traditions, they serve as pedagogical tools, vehicles for moral instruction, and mechanisms for social cohesion, embedding complex philosophical and ethical frameworks \cite{mbiti1990african}.
